...
const Header = ({ onSearch }) => {
  ...
  return (
    <div className="h-[6rem] w-full flex justify-between items-center">
      <img
        src="https://www.gameskinny.com/wp-content/uploads/gameskinnyc/a/6/0/a6078c-2fd9033b2be04c9b947d1aac6cdaef60-a2551.gif"
        alt=""
        className="h-[4rem] ml-4 cursor-pointer"
      />
      <div className="flex justify-center items-center relative">
        <input
          type="search"
          placeholder="pokemon search"
          className="outline-0 w-[30rem] border-2 border-blue-600 rounded-2xl pl-4 pr-20 py-2 pb-2.5"
          value={searchTerm}
